...
public class FlappyPlayer : MonoBehaviour {
    ...
    public FlappyObstaclesSpawner flappyObstacleSpawner;
    ...
    void Start()
    {
        ...
        dieSoundClip = Resources.Load("dieSound", typeof(AudioClip)) as AudioClip;
        flapSoundClip = Resources.Load("Fly", typeof(AudioClip)) as AudioClip;
        flappyObstacleSpawner = GameObject.FindGameObjectWithTag("Spawner").GetComponent<FlappyObstaclesSpawner>();
    }
    ...
    void Jump() {
        SoundSource.PlayOneShot(flapSoundClip);
	...
	void Die() {
        ...
        SoundSource.PlayOneShot(dieSoundClip);
    ...
    void OnTriggerEnter(Collider collider)
    {
        ...
        {
            flappyObstacleSpawner.SpawnObstacle();
        }
    }
}